...
class AccountsTest(unittest.TestCase):
    ...
    '''
    def setUp(self):
        self.new_account = userAccounts('instagram', 'kiira254', 'admin')
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_account.username, 'kiira254')
    ...
    def test_account_exist(self):
        ...
        '''
        userAccounts.add_account(self.new_account)
        self.assertTrue(userAccounts.account_exist('instagram', 'kiira254'))
    ...
    def test_get_account(self):
        ...
        '''
        userAccounts.add_account(self.new_account)
        get_account = userAccounts.get_account('instagram', 'kiira254')
        self.assertEqual(get_account.username,'kiira254')
